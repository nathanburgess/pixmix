...
TARFILES = ast.ml codegen.ml Makefile pixmix.ml parser.mly README \
        scanner.mll semant.ml testall.sh \
	$(TESTFILES:%=tests/%) 

pixmix-llvm.tar.gz : $(TARFILES)
	cd .. && tar czf pixmix-llvm/pixmix-llvm.tar.gz \
		$(TARFILES:%=pixmix-llvm/%)
