    ...
    let build_function_body fdecl =
        ...
        let handle_binop e1 op e2 dtype llbuilder =
            ...
            let float_ops op e1 e2 =
                ...
                | S.Less -> L.build_fcmp L.Fcmp.Ult e1 e2 "flt_lesstmp" llbuilder
                | S.Leq -> L.build_fcmp L.Fcmp.Ole e1 e2 "flt_leqtmp" llbuilder
                | S.Greater -> L.build_fcmp L.Fcmp.Ogt e1 e2 "flt_sgttmp" llbuilder
            ...
            let int_ops op e1 e2 =
                ...
                | S.Less -> L.build_icmp L.Icmp.Slt e1 e2 "lesstmp" llbuilder
                | S.Leq -> L.build_icmp L.Icmp.Sle e1 e2 "leqtmp" llbuilder
                | S.Greater -> L.build_icmp L.Icmp.Sgt e1 e2 "sgttmp" llbuilder
